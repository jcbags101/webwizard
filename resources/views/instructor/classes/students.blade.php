...
@section('instructor-content')
    ...
    @endif
    <div class="container">
        <h1 style="margin-top: 20px; font-size:20px">My Students in {{ $schoolClass->section->name }} -
            {{ $schoolClass->subject->name }} ({{ $schoolClass->subject->description }})</h1>
        ...
        @if (!$isShared)
            <div class="d-flex justify-content-end mb-3">
                ...
                <button type="button" class="btn btn-info me-2" data-bs-toggle="modal"
                    data-bs-target="#shareInstructorModal">
        ...
        <div class="modal fade" id="shareInstructorModal" tabindex="-1" aria-labelledby="shareInstructorModalLabel"
            aria-hidden="true">
                        ...
                        <form id="shareInstructorForm">
                            ...
                            <div class="text-end">
                                ...
                                <button type="button" class="btn btn-primary"
                                    onclick="shareWithInstructor()">Share</button>
                            </div>
                        </form>
                    </div>
                </div>
    ...
    <div class="mb-4">
        <nav class="nav-tabs">
            <div class="d-flex align-items-center justify-content-center bg-white rounded-top p-2 shadow-sm">
                <button class="btn btn-outline-danger rounded-pill me-3 px-4 py-2" type="button" data-bs-toggle="collapse"
                    data-bs-target="#midtermContent" aria-expanded="false" onclick="mainHideOthers('midtermContent')">
                    <i class="fas fa-file-alt me-2"></i>
                    <span class="fw-bold">Midterm</span>
                    <i class="fas fa-chevron-down ms-2"></i>
                </button>

                <button class="btn btn-outline-dark rounded-pill me-3 px-4 py-2" type="button" data-bs-toggle="collapse"
                    data-bs-target="#preFinalContent" aria-expanded="false" onclick="mainHideOthers('preFinalContent')">
                    <i class="fas fa-file-alt me-2"></i>
    ...
    <div class="mb-4 collapse" id="midtermContent">
        <nav class="nav-tabs mb-4">
            <div class="d-flex align-items-center justify-content-center bg-white rounded-top p-2 shadow-sm">
                <button class="btn btn-outline-primary rounded-pill me-3 px-4 py-2" type="button" data-bs-toggle="collapse"
                    data-bs-target=".gradeColumn" aria-expanded="false" onclick="hideOthers('gradeColumn')">
                    <i class="fas fa-pen-alt me-2"></i>
                    <span class="fw-bold">Quizzes</span>
                    <i class="fas fa-chevron-down ms-2"></i>
                </button>

                <button class="btn btn-outline-success rounded-pill me-3 px-4 py-2" type="button" data-bs-toggle="collapse"
                    data-bs-target=".oralColumn" aria-expanded="false" onclick="hideOthers('oralColumn')">
                    <i class="fas fa-comments me-2"></i>
                    <span class="fw-bold">Oral Participation</span>
                    <i class="fas fa-chevron-down ms-2"></i>
                </button>

                <button class="btn btn-outline-info rounded-pill me-3 px-4 py-2" type="button" data-bs-toggle="collapse"
                    data-bs-target=".projectColumn" aria-expanded="false" onclick="hideOthers('projectColumn')">
                    <i class="fas fa-project-diagram me-2"></i>
                    <span class="fw-bold">Project</span>
                    <i class="fas fa-chevron-down ms-2"></i>
                </button>

                <button class="btn btn-outline-warning rounded-pill px-4 py-2" type="button" data-bs-toggle="collapse"
                    data-bs-target=".termExamColumn" aria-expanded="false" onclick="hideOthers('termExamColumn')">
                    <i class="fas fa-file-alt me-2"></i>
    ...
    <div class="mb-4 collapse" id="preFinalContent">
        <nav class="nav-tabs mb-4">
            <div class="d-flex align-items-center justify-content-center bg-white rounded-top p-2 shadow-sm">
                <button class="btn btn-outline-primary rounded-pill me-3 px-4 py-2" type="button"
                    data-bs-toggle="collapse" data-bs-target=".preFinalGradeColumn" aria-expanded="false"
                    onclick="hideOthers('preFinalGradeColumn')">
                    <i class="fas fa-pen-alt me-2"></i>
                    <span class="fw-bold">Pre Final - Quizzes</span>
                    <i class="fas fa-chevron-down ms-2"></i>
                </button>

                <button class="btn btn-outline-success rounded-pill me-3 px-4 py-2" type="button"
                    data-bs-toggle="collapse" data-bs-target=".preFinalOralColumn" aria-expanded="false"
                    onclick="hideOthers('preFinalOralColumn')">
                    <i class="fas fa-comments me-2"></i>
                ...
                <button class="btn btn-outline-info rounded-pill me-3 px-4 py-2" type="button" data-bs-toggle="collapse"
                    data-bs-target=".preFinalProjectColumn" aria-expanded="false"
                    onclick="hideOthers('preFinalProjectColumn')">
                    <i class="fas fa-project-diagram me-2"></i>
                ...
                <button class="btn btn-outline-warning rounded-pill px-4 py-2" type="button" data-bs-toggle="collapse"
                    data-bs-target=".preFinalTermExamColumn" aria-expanded="false"
                    onclick="hideOthers('preFinalTermExamColumn')">
                    <i class="fas fa-file-alt me-2"></i>
                                ...
                                <td class="collapse gradeColumn">
                                    ...
                                    <div class="d-flex align-items-center">
                                        @for ($i = 1; $i <= 6; $i++)
                                            <div class="me-3">
                                                ...
                                                <div class="d-flex gap-2">
                                                    <div>
                                                        <input type="number" name="quiz{{ $i }}[]"
                                                            class="form-control form-control-sm quiz-input"
                                                            style="width: 80px;" min="0" max="100"
                                                            step="1" required
                                                            value="{{ $student->getClassRecord($schoolClass->id)->{'quiz_' . $i} ?? 0 }}"
                                                            {{ $isShared ? 'readonly' : '' }}>
                                                        <small class="text-muted">Score</small>
                                                    </div>
                                                    <div>
                                                        <input type="number" name="quiz{{ $i }}_percentage[]"
                                                            class="form-control form-control-sm quiz-percentage"
                                        ...
                                        <div class="me-3">
                                            ...
                                            <div class="d-flex gap-2">
                                                <div>
                                                    <input type="number" class="form-control form-control-sm quiz-total"
                                                        style="width: 80px;" readonly>
                                                    <small class="text-muted">Score</small>
                                                </div>
                                                <div>
                                                    <input type="number"
                                                        class="form-control form-control-sm quiz-total-percentage"
                                                        style="width: 80px;" readonly>
                                    ...
                                    <div class="d-flex align-items-center">
                                        @for ($i = 1; $i <= 6; $i++)
                                            <div class="me-3">
                                                ...
                                                <div class="d-flex gap-2">
                                                    <div>
                                                        <input type="number" name="oral{{ $i }}[]"
                                                            class="form-control form-control-sm oral-input"
                                                            style="width: 80px;" min="0" max="100"
                                                            step="1" required
                                                            value="{{ $student->getClassRecord($schoolClass->id)->{'oral_' . $i} ?? 0 }}"
                                                            {{ $isShared ? 'readonly' : '' }}>
                                                        <small class="text-muted">Score</small>
                                                    </div>
                                                    <div>
                                                        <input type="number" name="oral{{ $i }}_percentage[]"
                                                            class="form-control form-control-sm oral-percentage"
                                                            style="width: 80px;" readonly>
                                                        <small class="text-muted">EQU</small>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="me-3">
                                            ...
                                            <div class="d-flex gap-2">
                                                <div>
                                                    <input type="number" class="form-control form-control-sm oral-total"
                                                        style="width: 80px;" readonly>
                                                    <small class="text-muted">Score</small>
                                                </div>
                                                <div>
                                                    <input type="number"
                                                        class="form-control form-control-sm oral-total-percentage"
                                                        style="width: 80px;" readonly>
                                    ...
                                    <div class="d-flex align-items-center">
                                        @for ($i = 1; $i <= 4; $i++)
                                            <div class="me-3">
                                                ...
                                                <div class="d-flex gap-2">
                                                    <div>
                                                        <input type="number" name="project{{ $i }}[]"
                                                            class="form-control form-control-sm project-input"
                                                            style="width: 80px;" min="0" max="100"
                                                            step="1" required
                                                            value="{{ $student->getClassRecord($schoolClass->id)->{'project_' . $i} ?? 0 }}"
                                                            {{ $isShared ? 'readonly' : '' }}>
                                                        <small class="text-muted">Score</small>
                                                    </div>
                                                    <div>
                                                        <input type="number"
                                                            name="project{{ $i }}_percentage[]"
                                                            class="form-control form-control-sm project-percentage"
                                                            style="width: 80px;" readonly>
                                                        <small class="text-muted">EQU</small>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="me-3">
                                            ...
                                            <div class="d-flex gap-2">
                                                <div>
                                                    <input type="number"
                                                        class="form-control form-control-sm project-total"
                                                        style="width: 80px;" readonly>
                                                    <small class="text-muted">Score</small>
                                                </div>
                                                <div>
                                                    <input type="number"
                                                        class="form-control form-control-sm project-total-percentage"
                                                        style="width: 80px;" readonly>
                                                    <small class="text-muted">Percentage</small>
                                                </div>
                                            </div>
                                ...
                                <td class="collapse termExamColumn">
                                    <div class="d-flex align-items-center">
                                            ...
                                            <div class="d-flex gap-2">
                                                <div>
                                                    <input type="number" name="midterm[]"
                                                        class="form-control form-control-sm term-exam-input"
                                                        style="width: 80px;" min="0" max="100"
                                                        step="1" required
                                                        value="{{ $student->getClassRecord($schoolClass->id)->{'midterm'} ?? 0 }}"
                                                        {{ $isShared ? 'readonly' : '' }}>
                                                    <small class="text-muted">Score</small>
                                                </div>
                                                <div>
                                                    <input type="number" name="midterm_percentage[]"
                                                        class="form-control form-control-sm term-exam-percentage"
                                                        style="width: 80px;" readonly>
                                                    <small class="text-muted">EQU</small>
                                                </div>
                                            </div>
                                            ...
                                            <div class="d-flex gap-2">
                                                <div>
                                                    <input type="number" name="final[]"
                                                        ...
                                                        style="width: 80px;" min="0" max="100"
                                                        step="1" required
                                                        value="{{ $student->getClassRecord($schoolClass->id)->{'final'} ?? 0 }}"
                                                        {{ $isShared ? 'readonly' : '' }}>
                                                    <small class="text-muted">Score</small>
                                                </div>
                                                <div>
                                                    <input type="number" name="final_percentage[]"
                                                        class="form-control form-control-sm term-exam-percentage"
                                                        style="width: 80px;" readonly>
                                                    <small class="text-muted">EQU</small>
                                                </div>
                                        ...
                                        <div class="me-3">
                                            <label class="small">Total</label>
                                            <div class="d-flex gap-2">
                                                <input type="number" class="form-control form-control-sm term-exam-total"
                                                    style="width: 80px;" readonly>
                                            </div>
                                        </div>
                                        <div class="me-3">
                                            ...
                                            <div class="d-flex gap-2">
                                                <input type="number"
                                                    class="form-control form-control-sm term-exam-total-percentage"
                                                    style="width: 80px;" readonly>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="d-flex align-items-center">
                                        @for ($i = 1; $i <= 6; $i++)
                                            <div class="me-3">
                                                ...
                                                <div class="d-flex gap-2">
                                                    <div>
                                                        <input type="number" name="pre_final_quiz{{ $i }}[]"
                                                            class="form-control form-control-sm pre-final-quiz-input"
                                                            style="width: 80px;" min="0" max="100"
                                                            step="1" required
                                                            value="{{ $student->getClassRecord($schoolClass->id)->{'pre_final_quiz_' . $i} ?? 0 }}"
                                                            {{ $isShared ? 'readonly' : '' }}>
                                                        <small class="text-muted">Score</small>
                                                    </div>
                                                    <div>
                                                        <input type="number"
                                                            name="pre_final_quiz{{ $i }}_percentage[]"
                                                            class="form-control form-control-sm pre-final-quiz-percentage"
                                                            style="width: 80px;" readonly>
                                                        <small class="text-muted">EQU</small>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="me-3">
                                            ...
                                            <div class="d-flex gap-2">
                                                <div>
                                                    <input type="number"
                                                        class="form-control form-control-sm pre-final-quiz-total"
                                                        style="width: 80px;" readonly>
                                                    <small class="text-muted">Score</small>
                                                </div>
                                                <div>
                                                    <input type="number"
                                                        class="form-control form-control-sm pre-final-quiz-total-percentage"
                                                        style="width: 80px;" readonly>
                                                    <small class="text-muted">30%</small>
                                                </div>
                                            </div>
                                    ...
                                    <div class="d-flex align-items-center">
                                        @for ($i = 1; $i <= 6; $i++)
                                            <div class="me-3">
                                                ...
                                                <div class="d-flex gap-2">
                                                    <div>
                                                        <input type="number" name="pre_final_oral{{ $i }}[]"
                                                            class="form-control form-control-sm pre-final-oral-input"
                                                            style="width: 80px;" min="0" max="100"
                                                            step="1" required
                                                            value="{{ $student->getClassRecord($schoolClass->id)->{'pre_final_oral_' . $i} ?? 0 }}"
                                                            {{ $isShared ? 'readonly' : '' }}>
                                                        <small class="text-muted">Score</small>
                                                    </div>
                                                    <div>
                                                        <input type="number"
                                                            name="pre_final_oral{{ $i }}_percentage[]"
                                                            class="form-control form-control-sm pre-final-oral-percentage"
                                                            style="width: 80px;" readonly>
                                                        <small class="text-muted">EQU</small>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="me-3">
                                            ...
                                            <div class="d-flex gap-2">
                                                <div>
                                                    <input type="number"
                                                        class="form-control form-control-sm pre-final-oral-total"
                                                        style="width: 80px;" readonly>
                                                    <small class="text-muted">Score</small>
                                                </div>
                                                <div>
                                                    <input type="number"
                                                        class="form-control form-control-sm pre-final-oral-total-percentage"
                                                        style="width: 80px;" readonly>
                                                    <small class="text-muted">30%</small>
                                                </div>
                                            </div>
                                    ...
                                    <div class="d-flex align-items-center">
                                        @for ($i = 1; $i <= 4; $i++)
                                            <div class="me-3">
                                                ...
                                                <div class="d-flex gap-2">
                                                    <div>
                                                        <input type="number"
                                                            name="pre_final_project{{ $i }}[]"
                                                            class="form-control form-control-sm pre-final-project-input"
                                                            style="width: 80px;" min="0" max="100"
                                                            step="1" required
                                                            value="{{ $student->getClassRecord($schoolClass->id)->{'pre_final_project_' . $i} ?? 0 }}"
                                                            {{ $isShared ? 'readonly' : '' }}>
                                                        <small class="text-muted">Score</small>
                                                    </div>
                                                    <div>
                                                        <input type="number"
                                                            name="pre_final_project{{ $i }}_percentage[]"
                                                            class="form-control form-control-sm pre-final-project-percentage"
                                                            style="width: 80px;" readonly>
                                                        <small class="text-muted">EQU</small>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="me-3">
                                            ...
                                            <div class="d-flex gap-2">
                                                <div>
                                                    <input type="number"
                                                        class="form-control form-control-sm pre-final-project-total"
                                                        style="width: 80px;" readonly>
                                                    <small class="text-muted">Score</small>
                                                </div>
                                                <div>
                                                    <input type="number"
                                                        class="form-control form-control-sm pre-final-project-total-percentage"
                                                        style="width: 80px;" readonly>
                                ...
                                <td class="collapse preFinalTermExamColumn">
                                    <div class="d-flex align-items-center">
                                        <div class="me-3">
                                            ...
                                            <div class="d-flex gap-2">
                                                <div>
                                                    <input type="number" name="pre_final_midterm[]"
                                                        class="form-control form-control-sm pre-final-term-exam-input"
                                                        style="width: 80px;" min="0" max="100"
                                                        step="1" required
                                                        value="{{ $student->getClassRecord($schoolClass->id)->pre_final_midterm ?? 0 }}"
                                                        {{ $isShared ? 'readonly' : '' }}>
                                                    <small class="text-muted">Score</small>
                                                </div>
                                                <div>
                                                    <input type="number" name="pre_final_midterm_percentage[]"
                                                        class="form-control form-control-sm pre-final-term-exam-percentage"
                                                        style="width: 80px;" readonly>
                                                    <small class="text-muted">20%</small>
                                                </div>
                                            </div>
                                        ...
                                        <div class="me-3">
                                            ...
                                            <div class="d-flex gap-2">
                                                <div>
                                                    <input type="number" name="pre_final_final[]"
                                                        class="form-control form-control-sm pre-final-term-exam-input"
                                                        style="width: 80px;" min="0" max="100"
                                                        step="1" required
                                                        value="{{ $student->getClassRecord($schoolClass->id)->pre_final_final ?? 0 }}"
                                                        {{ $isShared ? 'readonly' : '' }}>
                                                    <small class="text-muted">Score</small>
                                                </div>
                                                <div>
                                                    <input type="number" name="pre_final_final_percentage[]"
                                                        class="form-control form-control-sm pre-final-term-exam-percentage"
                                                        style="width: 80px;" readonly>
                                                    <small class="text-muted">20%</small>
                                                </div>
                                        ...
                                        <div class="me-3">
                                            ...
                                            <div class="d-flex gap-2">
                                                <input type="number"
                                                    class="form-control form-control-sm pre-final-term-exam-total"
                                                    style="width: 80px;" readonly>
                                        ...
                                        <div class="me-3">
                                            ...
                                            <div class="d-flex gap-2">
                                                <input type="number"
                                                    class="form-control form-control-sm pre-final-term-exam-total-percentage"
                                                    style="width: 80px;" readonly>
                                            </div>
                                        </div>
                                    </div>
    ...
    <script>
        function hideOthers(currentId) {
            const allColumns = ['gradeColumn', 'oralColumn', 'projectColumn', 'termExamColumn', 'preFinalGradeColumn',
                'preFinalOralColumn', 'preFinalProjectColumn', 'preFinalTermExamColumn'
            ];
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function handleAssessmentCalculations(row, {
                ...
                function updateCalculations() {
                    ...
                    const validPercentages = Array.from(percentages).filter(input => input.value !== null && input
                        .value !== '');
                    const total = validPercentages.length > 0 ?
                        validPercentages.reduce((sum, input) => sum + (Number(input.value) || 0), 0) /
            ...
            document.querySelectorAll('tr').forEach(row => {
                ...
                handleAssessmentCalculations(row, {
                    ...
                    totalPercentageInput: row.querySelector(
                        '.pre-final-term-exam-total-percentage'),
        ...
        async function sendGrades() {
            try {
                const response = await fetch(
                    '{{ route('instructor.classes.students.send-grades', $schoolClass->id) }}', {
                        method: 'POST',
                        headers: {
                            'X-CSRF-TOKEN': '{{ csrf_token() }}',
                            'Accept': 'application/json',
